...
public class UserController
{
	...
	@ResponseBody
	public ModelAndView loadAjaxPage(@RequestParam(value = "action", required = false) String action)
	{
		if (action.equals("add"))
		{
			return new ModelAndView("sysMgt/addUser");
		}
	...
	public Map<String, Object> searchUser()
	{
		...
		logger.info("finish sysUser/list");
		return map;
	}
