...
<html lang="en-us">
	<head>
		...
		<!-- SmartAdmin RTL Support is under construction
			<link rel="stylesheet" type="text/css" media="screen" href="res/css/smartadmin-rtl.css"> -->
	...
	<body id="login" class="animated fadeInDown">
		...
		<header id="header">
			...
			<div id="logo-group">
				<span id="logo"> <img src="res/img/logo.png" alt="SmartAdmin"> </span>

				<!-- END AJAX-DROPDOWN -->
			</div>

			<span id="login-header-space"> <h4 class="hidden-mobile">Need an account?</h4> <a href="register.html" class="btn btn-danger">Creat account</a> </span>
